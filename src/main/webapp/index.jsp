...
<head>
    ...
    <style>
        ...
        * {
        ...
        #copy{#copy: #333; font-size: 0.85rem; margin-top: -225px; margin-left: 270px; }};
    ...
    <header class="p-3 text-bg-dark">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                ...
                <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
	                    <img src="https://static-00.iconduck.com/assets.00/f-letter-icon-2048x2048-1jnqbk05.png"
	                        class="icon">
	                    <div id="logo-name"><li><strong><a href="#" class="nav-link px-2 text-danger">actory Game</a></strong></li></div>
                </ul>
